...
def {function_name}({argument}):
    llm = ChatOpenAI(model_name="gpt-3.5-turbo-16k", openai_api_key=openai_api_key, request_timeout=120)
...
def {function_name}({argument}):
    ...
    model = ChatOpenAI(openai_api_key=openai_api_key, temperature=0, request_timeout=120)
