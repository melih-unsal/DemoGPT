...
Know that, you can use ai_engine for only ai functions for string inputs.
"""
...
4. If all the inputs are filled, use ai_engine to translate text to output language
...
3. If all the inputs are filled, use ai_engine to generate a solution for that question
4. If solution is ready, use ai_engine to generate multiple choice from the solution.
...
2. If hashtags are filled, use ai_engine to create tweet.
3. If tweet is created, use ai_engine to generate a score.
...
Let’s think step by step.
1. Use ai_engine to generate lectures
2. Get lecture from the user among those generated by ai_engine.
3. After user selects a lecture, generate topics releated to that lecture.
4. Get topic from the user among those generated by ai_engine.
5. After user selects the topic, use ai_engine to generate a question related to that topic and lecture
6. Get answer from the user.
7. Use ai_engine to validate the answer
